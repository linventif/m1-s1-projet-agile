package fr.univ.m1.projetagile.entretienVehicule.entity;
...
public class EntretienVehicule {
  ...
  public void planifierEntretien(LocalDate date) {
    if (date != null && date.isBefore(LocalDate.now())) {
      throw new IllegalArgumentException("La date de planification ne peut pas être dans le passé");
    }
   ...
   *
   * @throws IllegalStateException si l'entretien n'a pas été planifié avant d'être marqué comme
   *         réalisé
   */
