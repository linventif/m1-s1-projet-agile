 ...
 * 
 * <p>Ce package fournit un système de messagerie complet permettant aux utilisateurs
 * (Agents et Loueurs) de communiquer entre eux. Il est conçu comme un module indépendant
 * qui s'appuie sur le core métier sans le modifier.</p>
 * 
 * <h2>Architecture</h2>
 * <pre>
 * messagerie/
