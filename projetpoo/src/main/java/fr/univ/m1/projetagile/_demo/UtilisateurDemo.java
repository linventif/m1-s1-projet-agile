...
// AgentParticulier bobUpdated =
// (AgentParticulier) agentService.changeEmail(bob, "bob.maurise.new@gmail.com");
// System.out.println("Après: " + bobUpdated.getEmail());
...
// AgentParticulier aliceUpdated =
// agentService.updateAgentParticulierTelephone(aliceReloaded, "33699887766");
...
// System.out.println("--- Note: findAll() non implémenté ---");
// System.out.println("La méthode findAll() n'est pas disponible dans les services.");
// System.out.println("Les utilisateurs sont créés et peuvent être recherchés par email ou ID.");
...
// agentService.deleteUser(tempAgent.getIdU());
