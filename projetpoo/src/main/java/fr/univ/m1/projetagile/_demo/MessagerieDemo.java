...
// "Bonjour, je suis intéressé par votre véhicule Peugeot 208.");System.out.println("✓ Message 1
// envoyé et sauvegardé (ID: "+msg1.getId()+")");

// Message msg2 = service.envoyerMessage(agent, loueur,
// "Bonjour ! Oui, il est disponible. Quand souhaitez-vous le louer ?");System.out.println("✓
// Message 2 envoyé et sauvegardé (ID: "+msg2.getId()+")");

// Message msg3 = service.envoyerMessage(loueur, agent,
// "Je souhaiterais le louer du 15 au 20 décembre.");System.out.println("✓ Message 3 envoyé et
// sauvegardé (ID: "+msg3.getId()+")");

// Message msg4 = service.envoyerMessage(agent, loueur,
// "Parfait ! Je vais préparer le contrat de location.");System.out.println("✓ Message 4 envoyé et
// sauvegardé (ID: "+msg4.getId()+")");
...
// // Statistiques
// System.out.println("\n=== Statistiques ===");System.out.println("Messages envoyés par le loueur:
// "+service.getMessagesEnvoyes(loueur).size());System.out.println("Messages reçus par le loueur:
// "+service.getMessagesRecus(loueur).size());System.out.println("Total messages du loueur:
// "+service.getMessagesUtilisateur(loueur).size());System.out.println("Messages dans la
// conversation: "+service.compterMessagesConversation(loueur,agent));System.out.println("Ont
// échangé des messages: "+service.ontEchangeMessages(loueur,agent));
