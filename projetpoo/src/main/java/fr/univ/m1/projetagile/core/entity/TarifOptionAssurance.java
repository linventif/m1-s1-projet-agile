...
public class TarifOptionAssurance {
  ...
  public TarifOptionAssurance(String nomOption, String description, Double prix, GrilleTarif grilleTarif) {
  ...
  public String toString() {
    return "TarifOptionAssurance{" + "id=" + id + ", nomOption='" + nomOption + '\'' + ", prix=" + prix
        + '}';
  }
